...
fit = stan(file = "../code/simple-spatial-time-grouped.stan", data =test_data, iter=1000, chains=1)
...
scale_colors <- cm.colors(n.times)
my.colors <- scale_colors[rc]
plot(sg, axes=T)
points(ret$x, col = my.colors, lwd=4)
legend("topleft", pch=16, col=scale_colors,
